...
function App() {
  ...
  return (
    <div className="App">
      <div className='home'>
        <AddEmployee className="Add" addEmployee={addEmployee} setName={setName1} setLastname={setLastname1} setEmail={setEmail1} />
        <EmployeeList className="List" employees={employees} deleteEmployee={deleteEmployee} updateEmployee={updateEmployee}/>
      </div>
    </div>
  );
}
